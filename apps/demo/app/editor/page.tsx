    ...
    <div className="mb-6 flex items-start gap-2 rounded-lg bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 px-4 py-3">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-xs text-amber-700 dark:text-amber-300">
          ...
          use <strong>Export</strong> to download your <code className="font-mono bg-amber-200 dark:bg-amber-800 px-1 rounded text-amber-950 dark:text-amber-50">testimonials.config.json</code>,
          then load it into your own project alongside the <code className="font-mono bg-amber-200 dark:bg-amber-800 px-1 rounded text-amber-950 dark:text-amber-50">config-driven-testimonials</code> package.
        </p>
      </div>
