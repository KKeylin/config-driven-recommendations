...
const config: TestimonialConfig = {
  author: {
    ...
    linkedinUrl: 'https://linkedin.com/in/kkeylin',
  },
  testimonials: [
    {
      id: '10',
      ...
      date: '2026-02-19',
      source: { type: 'linkedin', url: 'https://www.linkedin.com/in/kkeylin/details/recommendations/' },
      associatedRole: { company: 'EPAM/First Derivative', period: '2024–2026' }, // TODO: уточни период
    ...
    },
    {
      ...
      weight: { level: 'peer', yearsExperience: 8 },
    },
    {
      id: '8',
      author: {
    ...
    },
    {
      ...
      weight: { level: 'peer', yearsExperience:  18},
    },
    {
      id: '6',
      author: {
    ...
    },
    {
      ...
      weight: { level: 'peer', yearsExperience: 4 },
    },
    {
      id: '1',
      author: {
