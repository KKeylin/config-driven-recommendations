...
// contain double quotes (e.g. [data-testid="..."]) that React would escape
...
// React 18 still holds ~65%(щт Ьфн 2026) of npm downloads and React 19 adoption is projected
// to reach plurality no sooner than 2029–2033. Requiring React 19 as a peer
// dependency would be premature for a general-purpose widget package.
