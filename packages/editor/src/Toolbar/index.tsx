    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center gap-2 px-6 h-12 bg-slate-800">
        ...
        {onClearRequest && (
          <>
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-md text-sm font-medium text-red-200 hover:bg-slate-700 hover:text-red-100 transition-colors"
            >
              Clear data
            </button>
          </>
        ...
        {backHref && (
          <a
            href={backHref}
            className="ml-auto flex items-center gap-1.5 text-sm font-medium text-slate-200 hover:text-white transition-colors"
          >
